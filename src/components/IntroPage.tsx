  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: 'var(--font-ibm)' }}>
      <div className="w-full max-w-4xl mx-auto text-center px-4 py-8">
        ...
        <div className="max-w-3xl mx-auto space-y-6 text-base">
        ...
        <div className="my-6">
          <h2 className="text-3xl text-center mb-6"><span className="text-blue-400" style={{ fontFamily: 'var(--font-bowlby)' }}>Choose</span> your <span className="font-bold font-mono">adventure</span></h2>
        ...
        <div className="bg-white rounded-lg p-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <a
              ...
              className="flex flex-col items-center p-4 rounded-lg transition-colors text-indigo-600 hover:text-indigo-700"
            >
              <span className="text-3xl mb-2">🛠️</span>
              <span className="text-blue-500">Tool Repository</span>
            ...
            >
              ...
              <span className="text-blue-500">SRCCON 2025 Session</span>
            ...
            >
              <span className="text-3xl mb-2">📧</span>
              <span className="text-blue-500">Contact Authors</span>
