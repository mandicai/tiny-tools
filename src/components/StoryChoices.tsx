                ...
                <div className="space-y-3 text-sm">
                    {choices.map((choice, idx) => (
                        <button
                            ...
                            className="group block w-full text-left p-5 rounded-lg bg-gradient-to-r from-blue-50 to-blue-50 hover:from-blue-100 hover:to-blue-100 border border-blue-200 hover:border-blue-300 shadow-sm hover:shadow-md transition-all duration-200 transform hover:-translate-y-0.5"
                        >
                            <div className="flex items-start space-x-3">

                                <div className="flex-1">
                                    <p className="text-gray-800 font-mono leading-relaxed group-hover:text-gray-900 transition-colors">
                                        {choice.text}
                                    </p>
                                </div>
                            </div>
